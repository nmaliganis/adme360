...
{
    public class CustomerUiModelToAdvertisedEntityAutoMapperProfile : Profile
    {
        public CustomerUiModelToAdvertisedEntityAutoMapperProfile()
        {
            ConfigureMapping();
        }
        ...
        {
            CreateMap<CustomerForCreationUiModel, Advertised>()
