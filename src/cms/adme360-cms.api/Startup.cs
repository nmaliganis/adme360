...
using System.Text;
using adme360.cms.api.Configurations;
using adme360.cms.api.Configurations.AutoMappingProfiles.Categories;
using adme360.cms.api.Configurations.AutoMappingProfiles.Customers;
using adme360.cms.api.Configurations.AutoMappingProfiles.Users;
using adme360.cms.api.Proxies;
  ...
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddSwaggerGen(c =>
      {
        ...
        {
          Title = "adme360-cms.api - HTTP API",
          Version = "v1",
          Description = "The Catalog Microservice HTTP API for adme360-cms.api service",
        });
    ...
    public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime lifetime)
    {
      ...
      app.UseSwagger()
        .UseSwaggerUI(c => { c.SwaggerEndpoint("/swagger/v1/swagger.json", "adme360-cms.api - API V1"); });
      ...
      {
        cfg.AddProfile<CategoryForModificationUiModelToCategoryEntityAutoMapperProfile>();
