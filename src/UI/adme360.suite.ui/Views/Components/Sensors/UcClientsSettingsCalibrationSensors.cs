...
{
    public partial class UcClientsSettingsCalibrationSensors : BaseModule, IUcManagementSensorSettingsCalibrationView
    {
        public UcClientsSettingsCalibrationSensors()
        {
            InitializeComponent();
            InitializePresenter();
        }
